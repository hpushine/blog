---
title: git命令大全
date: 2018-06-06 09:40:58
description: 这篇博客文章里记录一些git常用和一些记不住的命令，后面慢慢增加内容，可以当作命令参考手册使用，写到博客里方便自己查看。
tags: git
categories: 实践教程
---
...
git log --since=1.day #一天内的提交；你可以给出各种时间格式
...
git config --global format.pretty '%h : %s - %ad' --date=short 
#日期YYYY-MM-DD显示 写入全局配置
```
...
- [Git撤销一切，汇总各种回滚撤销的场景](https://github.com/blog/2019-how-to-undo-almost-anything-with-git)
